...
public class LavaPlanet extends POPPlanet {
	public LavaPlanet(int dimension) {
		super();
	...
	public LavaPlanet() {
		super();
		dimensionId = POPCelestials.lavaPlanet.dimensionId;
	}
	
	@Override
	public String getName() {
		return "Debug Lava Planet 1";
	}
	...
	public float getGravity() {
		return POPPlanet.getGCGravityFactor(2.2F);
	}
    ...
    public void registerWorldChunkManager() {
        this.worldChunkMgr = new POPDebugLavaChunkManager();
    }

    @Override
    public IChunkProvider createChunkGenerator() {
        return new POPDebugLavaChunkProvider(this.worldObj, this.worldObj.getSeed(), true);
    }
    ...
    public class POPDebugLavaChunkManager extends WorldChunkManager {
        @Override
	...
	public static short blockID = (short) Block.stone.blockID;
    
    public class POPDebugLavaChunkProvider extends ChunkProviderGenerate {
        ...
        private static final int CHUNK_SIZE_Y = 256;//*2;
        private static final int CHUNK_SIZE_Z = 16;
        private static final int CRATER_PROB = 100;
        private static final int LAVA_HEIGHT = 94;

        public POPDebugLavaChunkProvider(World par1World, long par2, boolean par4) {
            ...
            for (int x = 0; x < CHUNK_SIZE_X; x++) {
                for (int z = 0; z < CHUNK_SIZE_Z; z++) {
                    ...
                    if (d3 < 0.0D)
                        ...
                        yDev = d + (d2 - d) * d3;
                    yDev*=12.7*Math.sqrt((1730)*(1730)+(456)*(456))/832F;
                    for (int y = 0; y < CHUNK_SIZE_Y; y++) {
                        if ((y < (MID_HEIGHT + yDev) && y<CHUNK_SIZE_Y)) {
...
//1770, 456
        ...
        public Chunk provideChunk(int par1, int par2) {
            ...
            final short[] ids = new short[32768 * 2];//Changed from 2 as a test...
            	...
            	for (int z=0; z<CHUNK_SIZE_Z; z++)
		            for (int y = 0; y < LAVA_HEIGHT; y++)
		                if (ids[getIndex(x, y, z)]==0) {
		                    ids[this.getIndex(x, y, z)] = (short) Block.lavaStill.blockID;
		                    meta[this.getIndex(x, y, z)] = 0;
		                }
