...
public class WestMoonBillowed extends POPMoon {
	public WestMoonBillowed(int dimension) {
		super();
		dimensionId = dimension;
	}
	
	public WestMoonBillowed() {
		dimensionId = POPCelestials.westMoonBillowed.dimensionId;
	}
	
	@Override
	public String getName() {
		return "West Debug Moon - Billowed";
	}
	...
	public ResourceLocation getPlanetSprite() {
		return new ResourceLocation(PlanetsOPlenty.TEXTURE_DOMAIN, "textures/planets/westbillowed.png");
	}
	
	@Override
	public float getGravity() {
		return POPPlanet.getGCGravityFactor(.000001F);
	}
    ...
    public IChunkProvider createChunkGenerator() {
        return new POPWestBillowedProvider(this.worldObj, this.worldObj.getSeed(), true);
    }
	...
	public static short blockID = (short) Block.coalBlock.blockID;
    
    public class POPWestBillowedProvider extends ChunkProviderGenerate {
        ...
        public POPWestBillowedProvider(World par1World, long par2, boolean par4) {
            super(par1World, par2, par4);
            this.worldObj = par1World;
            this.rand = new Random(par2);
            this.noiseGen1 = new Billowed(this.rand.nextLong(), 4, 0.25);
        }
