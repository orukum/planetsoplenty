...
public class WestMoonGradient extends POPMoon {
	public WestMoonGradient(int dimension) {
		super();
		dimensionId = dimension;
	}
	
	public WestMoonGradient() {
		dimensionId = POPCelestials.westMoonGradient.dimensionId;
	}
	
	@Override
	public String getName() {
		return "West Debug Moon - Gradient";
	}
	...
	public ResourceLocation getPlanetSprite() {
		return new ResourceLocation(PlanetsOPlenty.TEXTURE_DOMAIN, "textures/planets/westgradient.png");
	}
	
	@Override
	public float getGravity() {
		return POPPlanet.getGCGravityFactor(.4F);
	}
    ...
    public IChunkProvider createChunkGenerator() {
        return new POPWestGradientProvider(this.worldObj, this.worldObj.getSeed(), true);
    }
    ...
    public class POPWestGradientProvider extends ChunkProviderGenerate {
        ...
        public POPWestGradientProvider(World par1World, long par2, boolean par4) {
