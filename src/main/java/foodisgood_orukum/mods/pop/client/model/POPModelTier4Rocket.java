package foodisgood_orukum.mods.pop.client.model;

import net.minecraft.client.model.ModelBase;
import net.minecraft.client.model.ModelRenderer;
import net.minecraft.entity.Entity;

public class POPModelTier4Rocket extends ModelBase
{
	// Roof, Floor, Bottom
	...
	public POPModelTier4Rocket()
	{
		this(0.0F);
	}

	public POPModelTier4Rocket(float var1)
	{
		this.textureWidth = 256;
		this.textureHeight = 256;
		//Roof
		this.inside[0] = new ModelRenderer(this, 0, 59);//Updated
		this.inside[0].addBox(-9F, -110F, -9F, 18, 1, 18, var1);
		...
		//Floor
		this.inside[1] = new ModelRenderer(this, 0, 78);//Update not needed
		...
		//Bottom
		this.inside[2] = new ModelRenderer(this, 0, 40);//Update not needed
		...
		this.top[0] = new ModelRenderer(this, 192, 60);//Updated
		this.top[0].addBox(-8F, -113F, -8F, 16, 2, 16, var1);
		...
		this.top[1] = new ModelRenderer(this, 200, 78);//Updated
		this.top[1].addBox(-7F, -115F, -7F, 14, 2, 14, var1);
		...
		this.top[2] = new ModelRenderer(this, 208, 94);//Updated
		this.top[2].addBox(-6F, -117F, -6F, 12, 2, 12, var1);
		...
		this.top[3] = new ModelRenderer(this, 216, 108);//Updated
		this.top[3].addBox(-5F, -119F, -5F, 10, 2, 10, var1);
		...
		this.top[4] = new ModelRenderer(this, 224, 120);//Updated
		this.top[4].addBox(-4F, -121F, -4F, 8, 2, 8, var1);
		...
		this.top[5] = new ModelRenderer(this, 232, 130);//Updated
		this.top[5].addBox(-3F, -123F, -3F, 6, 2, 6, var1);
		...
		this.top[6] = new ModelRenderer(this, 240, 138);//Updated
		this.top[6].addBox(-2F, -125F, -2F, 4, 2, 4, var1);
		...
		this.top[7] = new ModelRenderer(this, 248, 144);//Updated
		this.top[7].addBox(-1F, -141F, -1F, 2, 18, 2, var1);
		...
		this.base[0] = new ModelRenderer(this, 0, 0);//Update not needed
		...
		this.base[1] = new ModelRenderer(this, 0, 15);//Update not needed
		...
		this.base[2] = new ModelRenderer(this, 0, 28);//Update not needed
		...
		this.sides[0] = new ModelRenderer(this, 85, 0);//Updated
		this.sides[0].addBox(-3.9F, -111F, -8.9F, 8, 17, 1, var1);
		...
		this.sides[1] = new ModelRenderer(this, 103, 0);//Updated
		this.sides[1].addBox(3.9F, -111F, -8.9F, 5, 107, 1, var1);
		...
		this.sides[2] = new ModelRenderer(this, 85, 18);//Updated
		this.sides[2].addBox(-3.9F, -87F, -8.9F, 8, 83, 1, var1);
		...
		this.sides[3] = new ModelRenderer(this, 103, 108);//Updated
		this.sides[3].addBox(-8.9F, -111F, -8.9F, 5, 107, 1, var1);
		...
		//Added 53 to height
		this.sides[4] = new ModelRenderer(this, 120, 0);//Updated
		this.sides[4].addBox(-8.9F, -111F, -7.9F, 1, 107, 16, var1);
		...
		this.sides[5] = new ModelRenderer(this, 5, 114);//Updated
		this.sides[5].addBox(-8.9F, -111F, 8.1F, 17, 107, 1, var1);
		...
		this.sides[6] = new ModelRenderer(this, 119, 123);//Updated
		this.sides[6].addBox(8.1F, -111F, -7.9F, 1, 107, 17, var1);
